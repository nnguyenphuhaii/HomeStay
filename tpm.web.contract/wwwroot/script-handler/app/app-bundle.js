...
var paginationStyle3 = function ($timeout) {
    return {
        restrict: "E",
        ...
        templateUrl: "/script-handler/app/directives/pagination-style3/pagination-style3.html",
...
paginationStyle3.$inject = ["$timeout"];
...
addDirective("paginationStyle3", paginationStyle3);
